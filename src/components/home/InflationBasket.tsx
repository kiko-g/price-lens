...
export function InflationBasket() {
  return (
    <section className="w-full border-t border-teal-50/80 bg-white bg-linear-to-br from-teal-50/20 to-teal-50/20 py-12 md:py-16 lg:py-24 dark:border-transparent dark:bg-zinc-950 dark:from-teal-300/5 dark:to-teal-300/5">
      <div className="mx-auto w-full max-w-6xl px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <Badge className="bg-transparent bg-linear-to-br from-teal-600/70 to-violet-600/70 text-white dark:text-white">
          ...
          <div className="flex flex-col items-center justify-center gap-3">
            ...
            <p className="text-muted-foreground mx-auto max-w-3xl md:text-xl/relaxed lg:text-base/relaxed xl:text-lg/relaxed">
              ...
              <span className="font-medium text-teal-400 dark:text-teal-300">essentials</span> like tuna, eggs, milk,
              etc.?
            </p>
          </div>
