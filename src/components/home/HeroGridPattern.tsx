...
function Blobs() {
  return (
    <>
      ...
      <div className="bg-primary-500/30 dark:bg-primary-500/30 pointer-events-none absolute -top-20 left-0 h-[350px] w-[120vw] -translate-x-1/2 rounded-full blur-[100px] md:-top-40 md:right-0 md:left-auto md:h-[500px] md:w-[800px] md:translate-x-0 md:blur-[128px]" />
      {/* Secondary — centered on mobile, inset on desktop */}
      <div className="bg-secondary-500/30 dark:bg-secondary-400/30 pointer-events-none absolute -top-8 left-2/3 h-[250px] w-[80vw] -translate-x-1/2 rounded-full blur-[100px] md:-top-32 md:right-[20%] md:left-2/5 md:h-[400px] md:w-[600px] md:translate-x-0 md:blur-[128px]" />
    </>
  )
}
