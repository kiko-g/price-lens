...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      className={cn(
        "bg-background fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto max-h-[90svh] transform-gpu touch-pan-y flex-col overscroll-contain rounded-t-2xl border-t pt-[env(safe-area-inset-top,0px)] will-change-transform",
        className,
      )}
      {...props}
    >
