...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "border-input ring-offset-background placeholder:text-muted-foreground hover:bg-accent focus:ring-ring flex h-9 w-full items-center justify-between gap-0.5 rounded-md border bg-transparent px-3 py-2 text-sm whitespace-nowrap shadow-sm focus:ring-1 focus:outline-none disabled:cursor-not-allowed disabled:opacity-30 [&>span]:line-clamp-1",
      className,
    )}
    {...props}
  >
