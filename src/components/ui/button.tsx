...
rounded-md text-sm font-medium border border-transparent transition-colors disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0`,
  {
    variants: {
      variant: {
        ...
        secondary: `bg-emerald-600/80 border-emerald-600/90 text-white shadow-sm hover:bg-emerald-600/90 dark:bg-emerald-700/80 dark:border-emerald-700/90 dark:hover:bg-emerald-700/90 dark:text-white`,
