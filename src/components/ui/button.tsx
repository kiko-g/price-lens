...
const buttonVariants = cva(
  `inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium border border-transparent transition-all duration-150 active:scale-[0.97] disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0`,
  {
    variants: {
      variant: {
        ...
        "primary-soft": `bg-primary/10 shadow-sm text-foreground hover:bg-primary/20 dark:bg-primary/20 dark:hover:bg-primary/30 border-primary/30 dark:border-primary/40`,
        ...
        "gradient-primary": `bg-linear-to-r from-primary/80 to-secondary/80 text-white transition-all duration-300 dark:from-primary/90 dark:to-secondary/90 hover:opacity-80 border-transparent shadow-xl`,
      ...
      size: {
        ...
        icon: `p-2`,
        "icon-xl": `p-4 [&_svg]:size-5 active:scale-[0.94]`,
        "icon-lg": `p-3 [&_svg]:size-5 active:scale-[0.94]`,
        "icon-sm": `p-1.5 active:scale-[0.94]`,
        "icon-xs": `p-0.5 [&_svg]:size-3.5 active:scale-[0.94]`,
      },
      roundedness: {
        default: `rounded-md`,
        sm: `rounded-sm`,
