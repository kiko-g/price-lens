...
rounded-md text-sm font-medium border border-transparent transition-colors disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0`,
  {
    variants: {
      variant: {
        ...
        "gradient-primary": `bg-gradient-to-br from-indigo-500/70 to-blue-500/70 text-white hover:from-indigo-500/90 hover:to-blue-500/90 transition-all duration-300`,
      },
      size: {
        default: `px-3 py-1.5`,
