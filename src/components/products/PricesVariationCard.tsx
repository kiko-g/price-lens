      ...
      {!options.hideExtraInfo && (
        <div className={cn("mt-3 flex items-center justify-start gap-2")}>
          <Button
            ...
            size="sm"
            asChild
            className="max-w-28 gap-0.5 bg-white text-black [--background:var(--color-white)] [--foreground:var(--base-800)] hover:bg-white/90 dark:bg-white dark:hover:bg-white/90 [&_svg]:size-3"
          >
