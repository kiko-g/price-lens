...
type ProductBatchMilestoneProps = {
  ...
  loaded: number
  /** next-intl messages namespace for milestone strings */
  namespace?: "products.batch" | "deals.batch"
}
 ...
 */
export function ProductBatchMilestone({ loaded, namespace = "products.batch" }: ProductBatchMilestoneProps) {
