...
const PRIORITY_CONFIG: Record<string, { label: string; description: string; bgClass: string }> = {
  null: { label: "?", description: "Unset", bgClass: "bg-neutral-500" },
  "0": { label: "0", description: "Useless", bgClass: "bg-gray-800" },
  "1": { label: "1", description: "Minor", bgClass: "bg-rose-600" },
  "2": { label: "2", description: "Low", bgClass: "bg-orange-600" },
  "3": { label: "3", description: "Medium", bgClass: "bg-amber-600" },
  "4": { label: "4", description: "Important", bgClass: "bg-sky-600" },
  "5": { label: "5", description: "Essential", bgClass: "bg-emerald-700" },
}
