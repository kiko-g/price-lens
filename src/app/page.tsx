      ...
      <main className="flex w-full flex-col items-center justify-center">
        <div className="z-20 flex w-full flex-1 flex-col items-center justify-center gap-3 px-4 py-8 lg:flex-row lg:items-start lg:justify-start lg:gap-8 lg:px-20 lg:py-20">
          <div className="flex w-full flex-1 flex-col gap-4 pb-8 pt-16 md:gap-4 lg:pb-0 lg:pt-0">
            <h1 className="z-10 -translate-y-4 animate-fade-in text-balance bg-linear-to-br from-black from-30% to-black/40 bg-clip-text py-2 text-center text-4xl font-medium leading-none tracking-tighter text-transparent opacity-0 [--animation-delay:200ms] dark:from-white dark:to-white/40 sm:text-5xl md:text-left md:text-6xl lg:text-7xl">
              Price Lens
              <br className="block" />
              See through prices
            </h1>
            <p className="max-w-3xl -translate-y-4 animate-fade-in text-balance text-center tracking-tight text-gray-400 opacity-0 [--animation-delay:400ms] md:text-left md:text-lg">
          ...
          <div className="my-8 w-full max-w-full flex-1 self-start overflow-hidden lg:my-0 lg:w-auto lg:max-w-md">
            <MockChartA className="w-full border-zinc-100 bg-linear-to-br shadow-none dark:border-zinc-800 lg:border-border" />
          </div>
        </div>
