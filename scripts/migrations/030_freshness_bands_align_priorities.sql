-- Migration: Align scrape_freshness bands with priority refresh thresholds.
-- Old bands: <1h, 1-6h, 6-24h, 24-48h, >48h, never
-- New bands: <24h (P5), 24-48h (P4), 48h-3d (P3), 3-7d (P2), 7-14d (P1), >14d, never
-- Replaces compute_analytics_snapshot to emit the new JSON keys.
...
BEGIN
  ...
  sp_counts AS (
    SELECT
      ...
      -- Freshness bands aligned with priority refresh thresholds
